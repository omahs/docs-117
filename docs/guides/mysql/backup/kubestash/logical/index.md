...
menu:
  docs_{{ .version }}:
    identifier: guides-mysql-logical-backup
    name: Logical Backup
...
> **Note:** YAML files used in this tutorial are stored in [docs/guides/workloads/mysql/backup/kubestash/logical/examples](docs/guides/workloads/mysql/backup/kubestash/logical/examples) directory of [kubedb/docs](https://github.com/kubedb/docs) repository.
...
```bash
$ kubectl get repository -n demo sample-mysql-backup
NAME                    INTEGRITY   SNAPSHOT-COUNT   SIZE    PHASE   LAST-SUCCESSFUL-BACKUP   AGE
sample-mysql-backup     true        1                806 B   Ready   8m27s                    9m18s
```
...
gcs-mysql-repo-sample-mysql-backup-frequent-backup-1724065200   gcs-demo-repo   frequent-backup   2024-01-23T13:10:54Z   Delete            Succeeded   16h
```
