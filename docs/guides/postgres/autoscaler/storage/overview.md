...
- You should be familiar with the following `KubeDB` concepts:
  ...
  - [PostgresAutoscaler](/docs/guides/postgres/concepts/autoscaler.md)
...
<figure align="center">
  <img alt="Storage Auto Scaling process of Postgres" src="/docs/images/postgres/storage-process.svg">
