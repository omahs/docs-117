...
```bash
$ kubectl create -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/examples/RabbitMQ/monitoring/coreos-prom-mgo.yaml
RabbitMQ.kubedb.com/coreos-prom-mgo created
```
...
Selector:          app.kubernetes.io/instance=coreos-prom-mgo,app.kubernetes.io/managed-by=kubedb.com,app.kubernetes.io/name=RabbitMQs.kubedb.com
Type:              ClusterIP
...
<p align="center">
  <img alt="Prometheus Target" src="/docs/images/RabbitMQ/monitoring/mg-coreos-prom-target.png" style="padding:10px">
</p>
...
- [Backup and Restore](/docs/guides/RabbitMQ/backup/overview/index.md) process of RabbitMQ databases using Stash.
