...
One thing to note that, we internally use `--collect-all` args, if the RabbitMQ exporter version >= v0.31.0 . You can check the exporter version by getting the mgversion object, like this, 
