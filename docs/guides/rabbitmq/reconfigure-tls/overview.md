---
title: Reconfiguring TLS of RabbitMQ Database
menu:
  docs_{{ .version }}:
...
<figure align="center">
  <img alt="Reconfiguring TLS process of RabbitMQ" src="/docs/images/day-2-operation/RabbitMQ/mg-reconfigure-tls.svg">
<figcaption align="center">Fig: Reconfiguring TLS process of RabbitMQ</figcaption>
</figure>
