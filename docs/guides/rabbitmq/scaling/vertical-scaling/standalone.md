---
title: Vertical Scaling Standalone RabbitMQ
menu:
  docs_{{ .version }}:
...
```bash
$ kubectl apply -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/examples/RabbitMQ/scaling/vertical-scaling/mops-vscale-standalone.yaml
RabbitMQopsrequest.ops.kubedb.com/mops-vscale-standalone created
```
...
```bash
$ kubectl describe RabbitMQopsrequest -n demo mops-vscale-standalone
Name:         mops-vscale-standalone
Namespace:    demo
Labels:       <none>
Annotations:  <none>
...
kubectl delete RabbitMQopsrequest -n demo mops-vscale-standalone
```