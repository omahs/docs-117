---
title: RabbitMQ Standalone Volume Expansion
menu:
  docs_{{ .version }}:
...
```bash
$ kubectl create -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/examples/RabbitMQ/volume-expansion/mg-standalone.yaml
...
```bash
$ kubectl apply -f https://github.com/kubedb/docs/raw/{{< param "info.version" >}}/docs/examples/RabbitMQ/volume-expansion/mops-volume-exp-standalone.yaml
RabbitMQopsrequest.ops.kubedb.com/mops-volume-exp-standalone created
```
...
```bash
$ kubectl describe RabbitMQopsrequest -n demo mops-volume-exp-standalone
  Name:         mops-volume-exp-standalone
  Namespace:    demo
  Labels:       <none>
  ...
  Metadata:
    ...
    Self Link:         /apis/ops.kubedb.com/v1alpha1/namespaces/demo/RabbitMQopsrequests/mops-volume-exp-standalone
  ...
  Status:
    Conditions:
      ...
      Type:                  VolumeExpansion
      Last Transition Time:  2020-08-25T17:50:03Z
      Message:               Successfully Resumed RabbitMQ: mg-standalone
      Observed Generation:   1
...
kubectl delete RabbitMQopsrequest -n demo mops-volume-exp-standalone
```
