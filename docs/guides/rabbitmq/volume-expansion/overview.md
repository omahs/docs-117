...
This guide will give an overview on how KubeDB Ops-manager operator expand the volume of various component of `RabbitMQ` such as ReplicaSet, Shard, ConfigServer, Mongos, etc.
...
<figure align="center">
  <img alt="Volume Expansion process of RabbitMQ" src="/docs/images/day-2-operation/RabbitMQ/mg-volume-expansion.svg">
<figcaption align="center">Fig: Volume Expansion process of RabbitMQ</figcaption>
</figure>
...
5. Then, in order to expand the volume of the various components (ie. ReplicaSet, Shard, ConfigServer, Mongos, etc.) of the `RabbitMQ` database the user creates a `RabbitMQOpsRequest` CR with desired information.
